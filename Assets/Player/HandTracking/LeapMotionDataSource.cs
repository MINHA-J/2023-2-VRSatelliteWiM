    ...
    void IHandDataSource.UpdatePose(Hand hand) {
        ...
        foreach (var finger in handData.Fingers) {
            for (int j = 1; j < 4; j++) {
                ...
                Vector3 nextJointPos = currentBone.NextJoint;
                Vector3 prevJointPos = currentBone.PrevJoint;
    ...
    void IHandDataSource.UpdatePose(Hand hand, Hand.HandJoint joint) {
        ...
        switch(joint) {
            ...
            case Hand.HandJoint.IndexStart:
                ...
                transform.localRotation = TransformJointRotation(handData.GetIndex().bones[1].Rotation);
                break;
            case Hand.HandJoint.IndexMid:
                transform.localRotation = TransformJointRotation(handData.GetIndex().bones[2].Rotation);
                break;
            case Hand.HandJoint.IndexEnd:
                transform.localRotation = TransformJointRotation(handData.GetIndex().bones[3].Rotation);
                break;
            case Hand.HandJoint.MiddleStart:
                transform.localRotation = TransformJointRotation(handData.GetMiddle().bones[1].Rotation);
                break;
            case Hand.HandJoint.MiddleMid:
                transform.localRotation = TransformJointRotation(handData.GetMiddle().bones[2].Rotation);
                break;
            case Hand.HandJoint.MiddleEnd:
                transform.localRotation = TransformJointRotation(handData.GetMiddle().bones[3].Rotation);
                break;
            case Hand.HandJoint.RingStart:
                transform.localRotation = TransformJointRotation(handData.GetRing().bones[1].Rotation);
                break;
            case Hand.HandJoint.RingMid:
                transform.localRotation = TransformJointRotation(handData.GetRing().bones[2].Rotation);
                break;
            case Hand.HandJoint.RingEnd:
                transform.localRotation = TransformJointRotation(handData.GetRing().bones[3].Rotation);
                break;
            case Hand.HandJoint.PinkyStart:
                transform.localRotation = TransformJointRotation(handData.GetPinky().bones[1].Rotation);
                break;
            case Hand.HandJoint.PinkyMid:
                transform.localRotation = TransformJointRotation(handData.GetPinky().bones[2].Rotation);
                break;
            case Hand.HandJoint.PinkyEnd:
                transform.localRotation = TransformJointRotation(handData.GetPinky().bones[3].Rotation);
                break;
        }
